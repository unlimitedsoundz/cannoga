        ...
        <div className="relative w-full">
            ...
            >
                {cardsToRender.map((card, idx) => (
                    <div
                        key={card.id}
                        className="snap-start shrink-0 w-[88vw] sm:w-[440px] md:w-[500px] max-w-[380px] sm:max-w-none flex flex-col no-underline"
                    >
                        <Link
                        ...
                        >
                            ...
                            <div className="relative aspect-[4/3] sm:aspect-[16/11] w-full overflow-hidden rounded-sm bg-black/10">
                                <Image
                                    ...
                                    sizes="(max-width: 640px) 88vw, (max-width: 768px) 440px, 500px"
                                />
