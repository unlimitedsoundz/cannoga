...
const InvoicePDF: React.FC<InvoicePDFProps> = ({ invoice, payment }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{invoice?.transaction_reference || '—'}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Date:</Text>
            <Text style={styles.value}>{invoice?.created_at ? new Date(invoice.created_at).toLocaleDateString('en-CA') : '—'}</Text>
          </View>
          <View style={styles.row}>
