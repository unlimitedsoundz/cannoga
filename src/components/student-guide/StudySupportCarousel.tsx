...
const SUPPORT_CARDS: SupportCardItem[] = [
    {
        ...
        description: 'Programme level advising, degree course audits, and personalized study planning.',
        href: '/contact',
    ...
    },
    {
        ...
        description: 'Workshops, writing support, peer tutoring, and study skills development.',
        href: '#support',
    ...
    },
    {
        ...
        description: 'Internship placement, resume feedback, and international graduate career pathways.',
        href: '/careers',
...
export function StudySupportCarousel() {
    ...
    const handleScroll = () => {
        ...
        setActiveIndex(Math.min(Math.max(newIndex, 0), SUPPORT_CARDS.length - 1));
    };
    ...
    return (
        <div className="relative w-full my-6">
            <style jsx>{`
                ...
                .animate-arrow-support {
                    animation: arrowFloatSupport 2.2s ease-in-out infinite;
                }
            `}</style>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative z-20 pt-6 flex items-end justify-between gap-4 text-white">
                                ...
                                <div
                                    className="shrink-0 mb-0.5 animate-arrow-support group-hover:scale-110 transition-transform"
