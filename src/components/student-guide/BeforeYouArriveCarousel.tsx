...
const ARRIVAL_ITEMS: ArrivalChecklistItem[] = [
    {
        id: 'enrolment',
        title: 'ENROLMENT',
        description: 'Ensure you have accepted your admission offer, paid tuition fees, and completed official enrolment.',
    ...
    },
    {
        id: 'visa-permits',
        title: 'VISA & PERMITS',
        description: 'Apply for your Canadian study permit and access dedicated international student visa support.',
        href: '/international',
    ...
    },
    {
        id: 'what-to-bring',
        title: 'WHAT TO BRING',
        description: 'Bring your passport, study permit, insurance, and enrolment documents. Pack for the Canadian climate.',
        href: '#arriving',
...
export function BeforeYouArriveCarousel() {
    ...
    const handleScroll = () => {
        ...
        setActiveIndex(Math.min(Math.max(newIndex, 0), ARRIVAL_ITEMS.length - 1));
    };
    ...
    return (
        <div className="relative w-full my-6">
            <style jsx>{`
                ...
                .animate-arrow-arr {
                    animation: arrowFloatArr 2.2s ease-in-out infinite;
                }
            `}</style>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative z-20 pt-6 flex items-end justify-between gap-4 text-white">
                                ...
                                <div
                                    className="shrink-0 mb-0.5 animate-arrow-arr group-hover:scale-110 transition-transform"
