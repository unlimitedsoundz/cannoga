                ...
                <div className="cc-container py-8 md:py-12">
                    <div className="space-y-10">
                        ...
                        <section id="intro" className="scroll-mt-32">
                            <h2 className="text-aalto-5 font-bold mb-3 text-black tracking-tight">Purpose of This Guide</h2>
                            <p className="text-base text-neutral-600 leading-relaxed max-w-3xl font-medium">
                        ...
                        <section id="why-ottawa" className="scroll-mt-32">
                            <h2 className="text-aalto-5 font-bold mb-3 text-black tracking-tight">Why Study in Ottawa, Ontario, Canada?</h2>
                            <div className="grid lg:grid-cols-2 gap-6 items-center">
                                <div className="space-y-3">
                                    ...
                                    <div className="pt-1">
                                        <p className="font-semibold text-black text-xs md:text-sm leading-relaxed">
                        ...
                        <section id="admission" className="scroll-mt-32">
                            <h2 className="text-aalto-5 font-bold mb-3 text-black tracking-tight">Practical Things to Do After Admission</h2>
                        ...
                        <section id="arrival" className="scroll-mt-32">
                            <h2 className="text-aalto-5 font-bold mb-3 text-black tracking-tight">After Moving to Ottawa</h2>
                            <div className="grid lg:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    <h3 className="font-bold text-base text-black">Getting Around</h3>
                                    ...
                                    <div className="pt-1">
                                        <Link href="/student-guide/arrival" className="font-bold underline text-xs uppercase tracking-widest text-[#0a151a] inline-flex items-center gap-1">
                                            Full Arrival Guide <ArrowRight size={14} />
                                        </Link>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <h3 className="font-bold text-base text-black">Post-Arrival Checklist</h3>
                                    <ul className="space-y-2 text-xs md:text-sm">
                                        {[
                                            ...
                                            <li key={i} className="flex gap-2 items-start font-medium text-neutral-700">
                                                <span className="w-4 h-4 rounded-full bg-[#0a151a] text-white text-[10px] flex items-center justify-center shrink-0 mt-0.5 font-bold">{i + 1}</span>
                                                {item}
                                            </li>
                                        ))}
                                    </ul>
                        ...
                        <section id="living" className="scroll-mt-32">
                            <h2 className="text-aalto-5 font-bold mb-3 text-black tracking-tight">Living in Ottawa</h2>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div>
                                    <h3 className="font-bold text-base mb-1 text-black">Student Health Care</h3>
                                    <p className="text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">Once registered as a resident with an Ontario health card, you can access public healthcare through OHIP. In the interim, ensure you have private coverage. Cannoga partners with local clinics for walk-in care.</p>
                                </div>
                                <div>
                                    <h3 className="font-bold text-base mb-1 text-black">Local Culture</h3>
                                    <p className="text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">Ottawa is bilingual (English & French), diverse, and welcoming. It&apos;s one of the world's safest cities with a vibrant arts scene, national museums, and four distinct seasons.</p>
                                </div>
                                <div>
                                    <h3 className="font-bold text-base mb-1 text-black">Working While Studying</h3>
                                    <p className="text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">Your Canadian study permit allows you to work up to 30 hours/week during term time (full-time during holidays). Many local employers actively recruit Cannoga students.</p>
                                </div>
                                <div>
                        ...
                        <section id="support" className="scroll-mt-32">
                            <h2 className="text-aalto-5 font-bold mb-3 text-black tracking-tight">Support Services</h2>
                            <div className="grid md:grid-cols-3 gap-4">
                                <div>
                                    <h3 className="font-bold text-base mb-1 text-black">Peer Advice</h3>
                                    <p className="text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">Connect with current international students for practical tips on student life, housing, and finding your feet in Ottawa.</p>
                                </div>
                                <div>
                                    <h3 className="font-bold text-base mb-1 text-black">International Student Office</h3>
                                    <p className="text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">Guidance on study permits, enrollment, academic procedures, and immigration compliance throughout your studies.</p>
                                </div>
                                <div>
                                    <h3 className="font-bold text-base mb-1 text-black">Career & Settlement</h3>
                                    <p className="text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">Dedicated career support to help you plan your professional future and integrate into Ottawa&apos;s vibrant job market.</p>
                                </div>
                            </div>
                        </section>

                        {/* After Graduation */}
                        <section id="after-graduation" className="scroll-mt-32">
                            <h2 className="text-aalto-5 font-bold mb-3 text-black tracking-tight">After Graduation</h2>
                            <p className="text-xs md:text-sm text-neutral-600 leading-relaxed mb-4 max-w-3xl font-medium">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h3 className="text-base font-bold text-black mb-1">1. Apply for a Post-Graduation Work Permit (PGWP)</h3>
                                    <div className="space-y-1 text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">
                                ...
                                <div>
                                    <h3 className="text-base font-bold text-black mb-1">2. Gain Canadian Work Experience</h3>
                                    <p className="text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">
                                ...
                                <div>
                                    <h3 className="text-base font-bold text-black mb-1">3. Transition to Permanent Residency (PR)</h3>
                                    <div className="space-y-2 text-xs md:text-sm text-neutral-600 leading-relaxed font-medium">
                                        <div>
