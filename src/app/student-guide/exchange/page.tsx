            ...
            <div className="container mx-auto px-4 py-8 md:py-12 max-w-6xl">
                <div className="space-y-10 md:space-y-14 text-base md:text-lg font-normal text-black leading-relaxed">
                    ...
                    <section id="courses" className="scroll-mt-32 space-y-4">
                        <h2 className="text-aalto-5 font-bold text-black tracking-tight">Course Selection &amp; Academic Workload</h2>
                    ...
                    <section id="registration" className="scroll-mt-32 space-y-4">
                        <h2 className="text-aalto-5 font-bold text-black tracking-tight">Registration &amp; Student Portal Enrollment</h2>
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                    ...
                    <section id="housing" className="scroll-mt-32 space-y-4">
                        <h2 className="text-aalto-5 font-bold text-black tracking-tight">Housing &amp; Arrival Logistics</h2>
                        <div className="space-y-4 text-left">
                            <div>
                    ...
                    <section id="living" className="scroll-mt-32 space-y-4">
                        <h2 className="text-aalto-5 font-bold text-black tracking-tight">Student Life &amp; Community Benefits</h2>
