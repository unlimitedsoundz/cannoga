...
export const metadata: Metadata = {
    title: 'Advanced Diploma Student Guide | Cannoga College Ottawa',
    description: 'Comprehensive onboarding and reference guide for admitted 3-year Advanced Diploma students at Cannoga College Ottawa: offer confirmation, tuition fees, study permits, academic advising, applied capstone roadmap, and campus arrival.',
    alternates: {
...
export default async function AdvancedDiplomaGuidePage() {
    ...
    try {
        ...
        if (tuitionRows) {
            const masterRow = tuitionRows.find((r: any) => 
                (r.credential_type || '').toLowerCase().includes('master') || (r.credential_type || '').toLowerCase().includes('advanced')
            );
            if (masterRow) {
        ...
        console.error('Error fetching tuition in advanced diploma guide:', e);
    }
    ...
    const sections = [
        ...
        { id: 'advising', title: '4. Academic Advising & Capstone', content: '' },
        { id: 'it-account', title: '5. Student IT & Lab Portal', content: '' },
        { id: 'healthcare', title: '6. Healthcare & Transit', content: '' },
        { id: 'orientation', title: '7. Orientation & Arrival', content: '' },
    ...
    return (
        <div className="min-h-screen bg-white text-black font-sans pb-12">
            {/* HERO SECTION */}
            <Hero
                title="Advanced Diploma Student Guide"
                body="Official step-by-step onboarding guide for admitted 3-Year Advanced Diploma students at Cannoga College Ottawa campus. Complete all requirements before starting your studies."
                backgroundColor="#0a151a"
                tinted
                lightText={true}
                image={{
                    src: "/images/student-guide-master.png",
                    alt: "Advanced Diploma Students Guide"
                }}
            />
                    ...
                    <div className="space-y-10 md:space-y-14">
                        ...
                        <section id="tuition" className="scroll-mt-28 space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-6 bg-neutral-50">
                                    <span className="text-xs font-bold uppercase tracking-wider text-slate-500 block">International Advanced Diploma Tuition</span>
                                    <span className="text-base font-black text-black block mt-1">${intlTuition.toLocaleString()} CAD / yr</span>
                                    <span className="text-xs text-slate-600 mt-1 block">Full-time 3-year Advanced Diploma tuition across Business, Tech, Science &amp; Arts faculties.</span>
                                </div>
                                <div className="p-6 bg-neutral-50">
                                    <span className="text-xs font-bold uppercase tracking-wider text-slate-500 block">Domestic Advanced Diploma Tuition</span>
                                ...
                                <div className="p-6 bg-neutral-50 md:col-span-2">
                                    <span className="text-xs font-bold uppercase tracking-wider text-slate-500 block">Entrance &amp; Merit Awards</span>
                                    <span className="text-base font-black text-black block mt-1">Up to $5,000 CAD</span>
                                    <span className="text-xs text-slate-600 mt-1 block">Merit-based entrance awards and departmental assistantships assigned upon faculty review.</span>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-6 bg-neutral-50 space-y-2">
                                    ...
                                    <ul className="text-sm text-slate-600 space-y-1.5">
                                        ...
                                        <li>• Advanced Diploma 3-year programs provide full PGWP eligibility up to 3 years.</li>
                                        <li>• Family accompaniment: Spouses of eligible full-time students qualify for work authorizations.</li>
                                    </ul>
                                </div>
                                <div className="p-6 bg-neutral-50 space-y-2">
                                    ...
                                    <ul className="text-sm text-slate-600 space-y-1.5">
                                        ...
                                        <li>• Eligible for domestic tuition schedules and Ontario funding (OSAP).</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        {/* Step 4: Academic Advising & Capstone */}
                        <section id="advising" className="scroll-mt-28 space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="p-6 bg-neutral-50">
                                    <span className="font-bold text-base text-black block mb-1">Full-Time Academic Load</span>
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        4 to 5 courses (15 credits) per semester across 6 academic terms (3 years). Full-time registration is required to maintain valid immigration standing.
                                    </p>
                                </div>
                                <div className="p-6 bg-neutral-50">
                                    <span className="font-bold text-base text-black block mb-1">Faculty Academic Advisor</span>
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        Meet with your designated department advisor to define your technical specialization, co-op assignments, and capstone project requirements.
                                    </p>
                                </div>
                            </div>
                        </section>

                        {/* Step 5: Student IT & Lab Portal */}
                        <section id="it-account" className="scroll-mt-28 space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                ...
                                <div className="p-6 bg-neutral-50">
                                    <span className="font-bold text-sm text-black block">Campus Labs &amp; Wi-Fi</span>
                        ...
                        <section id="healthcare" className="scroll-mt-28 space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-6 bg-neutral-50 space-y-2">
                                    ...
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        International students are automatically enrolled in the Cannoga Comprehensive Student Health Insurance Plan (providing physician care, hospital stays, prescription medicines, and emergency medical protection). Ontario residents use OHIP.
                                    </p>
                                </div>
                                <div className="p-6 bg-neutral-50 space-y-2">
                        ...
                        <section id="orientation" className="scroll-mt-28 space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                                <div className="p-6 bg-neutral-50 text-sm">
                                    ...
                                    <span className="text-slate-600 text-xs">Engage with faculty deans, department chairs, and alumni fellows.</span>
                                </div>
                                <div className="p-6 bg-neutral-50 text-sm">
                                    <span className="font-bold text-black block mb-1">Campus &amp; Lab Tour</span>
                        ...
                        <section id="housing" className="scroll-mt-28 space-y-4">
                            <div className="flex items-center gap-3.5">
                                <StepBadge step={8} />
                                <h2 className="text-2xl md:text-3xl font-black text-black tracking-tight">
                                    Housing, Funding &amp; Career Pathways
                                </h2>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-6 bg-neutral-50 space-y-2">
                                    ...
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        Cannoga assists students with quiet, modern apartment rentals and partner residences near campus in Ottawa (ByWard Market, Sandy Hill, Vanier, and Downtown).
                                    </p>
                                </div>
                                <div className="p-6 bg-neutral-50 space-y-2">
                                    <span className="font-bold text-base text-black block">PGWP &amp; Career Pathways</span>
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        Graduates of full-time 3-year Advanced Diploma programmes in Canada qualify for up to a 3-year Post-Graduation Work Permit (PGWP), creating a direct pathway to permanent residency and professional career growth.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="pt-2 flex flex-col sm:flex-row gap-4">
                                ...
                                >
                                    Explore Student Housing <ArrowRight size={14} weight="bold" />
                                </Link>
                                <Link
