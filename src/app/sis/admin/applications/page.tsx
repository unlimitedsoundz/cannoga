...
export default function ApplicationsPage() {
  ...
  const columns = [
    ...
    { key: 'course', header: 'Program', render: (a: ApplicationRow) => <span className="text-xs text-neutral-400">{`${a.course?.title || '—'}${a.course?.degreeLevel ? ` — ${formatDegreeLevel(a.course.degreeLevel)}` : ''}`}</span> },
