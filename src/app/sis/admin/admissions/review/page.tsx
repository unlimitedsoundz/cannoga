      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-neutral-200 p-6">
            ...
            <dl className="grid grid-cols-2 gap-4 text-sm">
              <div><dt className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">Name</dt><dd className="font-medium text-neutral-900 mt-1">{application.user?.first_name} {application.user?.last_name}</dd></div>
              <div><dt className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">Email</dt><dd className="font-medium text-neutral-900 mt-1 font-mono text-xs">{application.user?.email}</dd></div>
              <div><dt className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">Phone</dt><dd className="font-medium text-neutral-900 mt-1">{application.user?.phone}</dd></div>
              <div><dt className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">Date of Birth</dt><dd className="font-medium text-neutral-900 mt-1">{application.user?.date_of_birth}</dd></div>
              <div className="col-span-2"><dt className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">Address</dt><dd className="font-medium text-neutral-900 mt-1">{application.user?.address}</dd></div>
            </dl>
          </div>
          ...
          <div className="bg-white border border-neutral-200 p-6">
            ...
            <dl className="grid grid-cols-2 gap-4 text-sm">
              <div><dt className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">High School</dt><dd className="font-medium text-neutral-900 mt-1">{application.education_history?.highSchool}</dd></div>
              <div><dt className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">Graduation Year</dt><dd className="font-medium text-neutral-900 mt-1">{application.education_history?.graduationYear}</dd></div>
              <div><dt className="text-[10px] font-bold uppercase tracking-wider text-neutral-400">GPA</dt><dd className="font-medium text-neutral-900 mt-1">{application.education_history?.gpa}</dd></div>
            </dl>
          </div>
