...
const tabs = [
  { label: 'Overview', href: '/sis/students/1/academic-record' },
  { label: 'Courses', href: '/sis/students/1/academic-record/courses' },
  { label: 'Grades', href: '/sis/students/1/academic-record/grades' },
  { label: 'Progress', href: '/sis/students/1/academic-record/progress' },
  { label: 'Transcript', href: '/sis/students/1/academic-record/transcript' },
];
