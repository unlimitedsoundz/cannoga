        ...
        <div className="tuition-page min-h-screen bg-white text-black font-sans">
            ...
            >
                <div className="cc-container py-8 md:py-16">
                    <main className="space-y-12 md:space-y-16 text-lg font-normal text-black leading-relaxed">
                        ...
                        <section id="fee-structure" className="scroll-mt-32 space-y-4">
                            ...
                            <div className="space-y-4">
                                <DbPageContent pageSlug={pageSlug} sectionKey="costs_intro_content" fallbackContent={getContent('costs_intro_content')} className="space-y-4 text-lg font-normal text-black leading-relaxed" />
                            </div>
                                        ...
                                        {['CERTIFICATE', 'DIPLOMA', 'BACHELOR', 'MASTER'].map((credentialType, idx) => {
                                            ...
                                            return (
                                                <tr key={credentialType} className={idx % 2 === 0 ? 'bg-white hover:bg-neutral-50/60' : 'bg-neutral-50/80 hover:bg-neutral-100/60'}>
                                                    ...
                                                    <td className="px-2 py-2.5 sm:px-4 sm:py-3.5 text-xs sm:text-base font-normal text-black align-middle">{display.duration}</td>
                                                    <td className="px-2 py-2.5 sm:px-4 sm:py-3.5 text-xs sm:text-base font-normal text-black align-middle">{display.credits}</td>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
                                <div className="space-y-2">
                                    ...
                                    <DbPageContent pageSlug={pageSlug} sectionKey="certificate_fees_content" fallbackContent={getContent('certificate_fees_content')} className="space-y-3 text-lg font-normal text-black leading-relaxed" />
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <DbPageContent pageSlug={pageSlug} sectionKey="master_fees_content" fallbackContent={getContent('master_fees_content')} className="space-y-3 text-lg font-normal text-black leading-relaxed" />
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="merit-scholarship" className="scroll-mt-32 space-y-4">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <ul className="space-y-2 pt-1 text-lg font-normal text-black leading-relaxed list-disc list-outside pl-5">
                        ...
                        <section id="payment-methods" className="scroll-mt-32 space-y-4">
                            ...
                            <DbPageContent pageSlug={pageSlug} sectionKey="payment_methods_content" fallbackContent={getContent('payment_methods_content')} className="space-y-4 text-lg font-normal text-black leading-relaxed" />
                        </section>
                        ...
                        <section id="timing" className="scroll-mt-32 space-y-4">
                            ...
                            <DbPageContent pageSlug={pageSlug} sectionKey="timing_content" fallbackContent={getContent('timing_content')} className="space-y-4 text-lg font-normal text-black leading-relaxed" />
                        </section>
                        ...
                        <section id="additional-fees" className="scroll-mt-32 space-y-4">
                            ...
                            <DbPageContent pageSlug={pageSlug} sectionKey="additional_fees_content" fallbackContent={getContent('additional_fees_content')} className="space-y-6 text-lg font-normal text-black leading-relaxed" />
                        </section>
                        ...
                        <section id="refunds" className="scroll-mt-32 space-y-4">
                            ...
                            <DbPageContent pageSlug={pageSlug} sectionKey="refunds_content" fallbackContent={getContent('refunds_content')} className="space-y-6 text-lg font-normal text-black leading-relaxed" />
                        </section>
                        ...
                        <section id="contact" className="scroll-mt-32 space-y-4">
                            ...
                            <DbPageContent pageSlug={pageSlug} sectionKey="contact_content" fallbackContent={getContent('contact_content')} className="space-y-4 text-lg font-normal text-black leading-relaxed" />
                        </section>
