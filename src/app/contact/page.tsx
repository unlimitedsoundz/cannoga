        ...
        <main className="min-h-screen bg-white text-black antialiased font-sans pb-20">
            ...
            <div className="container mx-auto max-w-5xl px-4 py-16 space-y-16 text-base md:text-lg font-normal text-black leading-relaxed">
                ...
                <section id="contact-directory" className="scroll-mt-32 space-y-8">
                    ...
                    <div className="flex flex-col gap-6 pt-2">
                        ...
                        <div className="space-y-1">
                            ...
                            <a href="mailto:admissions@cannogacollege.ca" className="text-slate-500 font-bold underline hover:text-black transition-colors text-base md:text-lg block">
                        ...
                        <div className="space-y-1">
                            ...
                            <a href="tel:+12272500427" className="text-slate-500 font-bold underline hover:text-black transition-colors text-base md:text-lg block">
                                Talk to Admissions
                            </a>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <a
                                ...
                                className="text-slate-500 font-bold underline hover:text-black transition-colors text-base md:text-lg block"
                            >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base md:text-lg text-black font-normal">
                ...
                <section className="pt-8 border-t border-slate-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 border border-slate-200 hover:border-black transition-colors rounded-sm space-y-2">
                            ...
                            <p className="text-base md:text-lg text-black font-normal leading-relaxed">Responsible for receiving official academic correspondence and documentation.</p>
                        ...
                        <div className="p-6 border border-slate-200 hover:border-black transition-colors rounded-sm space-y-2">
                            ...
                            <p className="text-base md:text-lg text-black font-normal leading-relaxed">Information on degree programmes, requirements, scholarships, and deadlines.</p>
                        ...
                        <div className="p-6 border border-slate-200 hover:border-black transition-colors rounded-sm space-y-2">
                            ...
                            <p className="text-base md:text-lg text-black font-normal leading-relaxed">Comprehensive support for enrolled students including study planning and guidance.</p>
                        ...
                        <div className="p-6 border border-slate-200 hover:border-black transition-colors rounded-sm space-y-2">
                            ...
                            <p className="text-base md:text-lg text-black font-normal leading-relaxed">Permanent academic records storage, transcript verification, and archival documents.</p>
                ...
                <section className="pt-8 border-t border-slate-200">
                    ...
                    <p className="text-black text-base md:text-lg mb-6 leading-relaxed font-normal">
