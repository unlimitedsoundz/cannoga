        ...
        <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {access.map((item) => (
                    <div
                        key={item.id}
                        className="bg-white border-2 border-[#9c27b3] p-5 rounded-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all"
                    >
                        <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-[#9c27b3] text-white rounded-sm flex items-center justify-center">
                        ...
                        {item.asset?.access_url && (
                            <div className="mt-4">
                                <a
                                    ...
                                    className="inline-block px-4 py-2 bg-[#9c27b3] text-white rounded-sm text-[10px] font-black uppercase tracking-widest hover:bg-neutral-800 transition-all"
                                >
                                    Access Portal →
                                </a>
                            </div>
