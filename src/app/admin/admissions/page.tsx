                                    ...
                                    <tr key={app.id} className="hover:bg-neutral-50/50 transition-colors group block md:table-row p-4 md:p-0">
                                        ...
                                        <td className="block md:table-cell pt-4 pb-2 md:p-6 text-right">
                                            <Link
                                                ...
                                                className="inline-flex items-center gap-2 bg-neutral-100 px-4 py-2 rounded-none text-xs text-black font-black uppercase tracking-widest hover:bg-[#9c27b3] hover:text-white transition-all active:scale-95"
                                            >
