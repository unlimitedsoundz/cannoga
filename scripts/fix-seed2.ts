...
const firstRoomLine = verify.match(/INSERT INTO public\.rooms[\s\S]*?VALUES\n\s*\(/);
console.log('First room row starts with:', firstRoomLine ? firstRoomLine[0].substring(0, 100) : 'not found');
