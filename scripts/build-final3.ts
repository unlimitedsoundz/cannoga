...
// No ON CONFLICT - let IDs auto-generate
...
// Remove hardcoded IDs from room_features INSERT
completeSeed = completeSeed.replace(
...
const roomsOnConflict = verify.match(/INSERT INTO public\.rooms[\s\S]*?ON CONFLICT[\s\S]*?;/);
console.log('Rooms ON CONFLICT:', roomsOnConflict ? 'present' : 'absent');
